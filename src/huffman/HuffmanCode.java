...
class HuffmanLeaf extends HuffmanTree {
	...
	HuffmanLeaf(double freq, char val) {
		super(freq);
		value = val;
	}
}
...
public class HuffmanCode {
	...
	public String toString() {
		...
		for (Character c : compressedResult.keySet()) {
			...
			formatter.format("%3.6s", c);
			str += "'" + formatter + "'" + "\t\t" + Math.round(characterFrequency.get(c) * 100.0) / 100.0 + "\t\t"
